...
All front end assets can be found in the `public` directory. Please use a javascript MV* framework of your choice to build a single page application for playing the game. The static page currently found at `index.html` represents the game state upon finishing a match.
...
If you have any questions while working on the test, feel free to contact Ben Wilhelm <ben.wilhelm@domandtom.com>.
